...
public class TextUITester {
    ...
    public static void runCommandLoopDisplayMenu() {
    ...
    public static void runDisplayMenu() {
    	Scanner scnr = new Scanner(System.in);
    ...
    public static void runDisplayBooks() {
    	
    }
    
    public static void runISBNLookup() {
    	Scanner scnr = new Scanner(System.in);
    ...
    public static void runTitleSearch() {
    	Scanner scnr = new Scanner(System.in);
